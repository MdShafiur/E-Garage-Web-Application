    ...
    <body>
        ...
        <div class="page-section">
            <div class="container">
                <h1 class="mb-5 text-center wow fadeInUp">Our Technicians</h1>
                ...
                <div class="owl-carousel wow fadeInUp" id="doctorSlideshow">
                    <div class="item">
                        <div class="card-doctor">
                            ...
                            <div class="body">
                                <p class="mb-0 text-xl">Najmul Islam</p>
                                <span class="text-sm text-grey">Senior Technician</span>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="card-doctor">
                            ...
                            <div class="body">
                                <p class="mb-0 text-xl">Eyenan Tajrian</p>
                                <span class="text-sm text-grey">Financial Analyst</span>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="card-doctor">
                            ...
                            <div class="body">
                                <p class="mb-0 text-xl">Abrar Hossain</p>
                                <span class="text-sm text-grey">Support Engineer</span>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="card-doctor">
                            ...
                            <div class="body">
                                <p class="mb-0 text-xl">Fahad Tanvir Rafi</p>
                                <span class="text-sm text-grey">Heavy Equipment Technician</span>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="card-doctor">
                            ...
                            <div class="body">
                                <p class="mb-0 text-xl">Muneem Shahriar</p>
                                <span class="text-sm text-grey">Electronics Technician</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="page-section">
            <div class="container">
                ...
                <form class="main-form">
                  ...
                  <option value="general">Vehicle preventive maintenance</option>
                  <option value="cardiology">Brake repair & maintenance</option>
                  <option value="dental">Radiator maintenance & replacement</option>
                  <option value="neurology">Throttle body maintenance</option>
                  <option value="orthopaedics">Air conditioning repair & maintenance</option>
